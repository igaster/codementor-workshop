<x-app-layout>
    ...
    <div class="container mx-auto py-10">
        <div class="new-todo-form flex column">
            <form action="/task" class="contents" method="POST">
                @csrf
                <input
            ...
            @foreach($tasks as $task)
                ...
                <li class="flex row items-center justify-between w-full py-1 px-4 my-1 rounded border bg-gray-200 border-gray-300 text-gray-600">
                    ...
                    <span class="py-2 float-right">
                        <a href="#" class="bg-indigo-400 hover:bg-indigo-500 text-white font-semibold p-0 px-1 border border-indigo-600 rounded inline-block">
                ...
                <li class="flex row items-center justify-between w-full py-1 px-4 my-1 rounded border bg-gray-200 border-gray-300 text-gray-600">
                    ...
                    <span class="py-2 float-right">
                        ...
                        <a href="#" class="bg-emerald-400 hover:bg-emerald-500 text-white font-semibold p-0 px-1 border border-emerald-600 rounded inline-block">
